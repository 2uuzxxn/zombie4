...
const BETRAYAL_TRIGGER_TIME = 30;
...
// 9. 컬러 설정 (HEX 값)
const COLOR_TEAM   = '#00E676';  // 네온 그린
const COLOR_A      = '#FF1744';  // 핫 레드
const COLOR_B      = '#00B0FF';  // 일렉트릭 블루
const COLOR_ZOMBIE = '#AA00FF';  // 바이올렛
const COLOR_EMPTY  = '#0A0A0F';  // 딥 블랙
const COLOR_GRID   = '#141420';  // 다크 그리드
